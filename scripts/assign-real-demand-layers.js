...
// tiled.js), 27 из 36 плиток удалось (публичный Overpass после ~25
// запросов подряд начинает рвать соединения) - известный пробел, см.
// journal.md. У большинства зданий building=yes (общий тег без уточнения,
