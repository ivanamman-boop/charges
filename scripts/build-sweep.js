...
<body>
  ...
  <p class="lead">${tiles.length} квадратов по ${STEP_KM}×${STEP_KM} км покрывают Москву внутри МКАД. Пройдите все — и в данных не останется дыр. Страница работает без установки чего-либо: откройте файл в Google Chrome на любом компьютере (Windows или Mac).</p>
  <div class="layout">
    <div class="card">
    ...
    <div class="card">
      ...
      <ol>
        ...
        <li>Перешлите файл на Mac (Telegram, почта, флешка) — дальше импорт: <code>npm run import:yandex -- ~/Downloads/файл.har</code>. Файл может весить 50–150 МБ.</li>
      </ol>
