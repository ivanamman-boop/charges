...
<body>
  ...
  <div class="warn" style="margin:0 0 1rem"><b>Сначала проверка:</b> пройдите квадраты 1 и 2, сохраните HAR и пришлите его — проверим, что станции записываются, и только потом проходите остальные. Объезд 24.09 (21 файл) из-за фильтра Fetch/XHR не записал ни одной станции.</div>
  <div class="layout">
    <div class="card">
    ...
    <div class="card">
      ...
      <ol>
        ...
        <li>В этой вкладке откройте DevTools: <code>F12</code> или <code>Ctrl+Shift+I</code> на Windows, <code>Cmd+Option+I</code> на Mac. Вкладка <b>Network</b> → включите <b>Preserve log</b>, фильтр — <b>All (Все)</b>, <u>не</u> Fetch/XHR: при открытии по ссылке Яндекс присылает результаты внутри самой страницы, и фильтр Fetch/XHR их отсекает. Затем обновите страницу: <code>F5</code> / <code>Cmd+R</code>.</li>
        <li>Дождитесь, пока на карте появятся станции, затем <b>чуть-чуть сдвиньте карту мышкой</b> (на сантиметр) — Яндекс пришлёт результаты отдельным запросом. Масштаб не меняйте.</li>
  ...
  <script>
    const KEY = 'yandex-sweep-done-v3';
    const SAVE_KEY = 'yandex-sweep-saved-v3';
